...
The pyDischarge package contains classes and utilities providing tools and methods for studying data from partial discharge detectors, for astrophysical or instrumental purposes.
...
Additionally, much of the methodology has been derived from, and augmented by, the `LIGO Algorithm Library Suite (LALSuite) <https://www.lsc-group.phys.uwm.edu/daswg/projects/lalsuite.html>`_, a large collection of primarily ``C99`` routines for analysis and manipulation of data from partial discharge detectors.
